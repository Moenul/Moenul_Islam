<div class="nav_bar">
    ...
    <div class="nav_list">
        <ul>
            ...
            <a href=""><li><iconify-icon icon="solar:notes-broken"></iconify-icon> <span>Resume</span></li></a>
            <a href="{{ url('/#contact') }}"><li><iconify-icon icon="solar:call-chat-outline"></iconify-icon> <span>Say hello?</span></li></a>
        </ul>
    </div>
    <div class="nav_brand"><a href="{{ url('/') }}"><img style="width:100%" src="{{ asset('images/Logo.png') }}"></a></div>
</div>
