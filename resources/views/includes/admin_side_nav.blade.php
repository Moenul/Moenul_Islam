<div class="side_nav">
    ...
    <a href=""><li class="side_nav_item"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></li></a>

    <li class="side_nav_item"><i class="far fa-clipboard"></i><span>Posts</span>
