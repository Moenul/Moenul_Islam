            ...
            @if ($articals)
                @foreach ($articals as $artical)
                    <div class="artical">
                        ...
                        <div class="artical_views"><a href="{{ Route('articals.show', $artical->slug) }}" class="see_more">See More </a> <p> <span class="iconify" data-icon="carbon:view-filled"></span> 2034</p></div>
                    </div>
                @endforeach
